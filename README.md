...
4. Enroll in the Gradescope Course using code: BK8D46
...
1. On Gradescope, when you click on the "Lab 1: Git and GitHub" assignment, you will be asked to connect your GitHub account. 
